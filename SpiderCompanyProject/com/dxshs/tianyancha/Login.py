...
class Tianyan():
    def __init__(self, user, pwd):
        self.browser = webdriver.Chrome('/Users/liuxian/Downloads/chromedriver')  # 实例化浏览器对象，并命名为 browser
        self.user = user
        self.pwd = pwd
    ...
    def get_url(self):
        ...
        button2 = self.wait.until(
            EC.element_to_be_clickable((By.XPATH, '//div[@class="login-warp"]/div[1]/div[3]/div[1]/div[2]')))
        button2.click()
    ...
    def check_login(self):
        try:
            ...
            input_psw = self.browser.find_element_by_xpath(
    ...
    def check_company(self, company):
        ...
        company_click = self.wait.until(
            EC.element_to_be_clickable((By.XPATH, '//div[@class="input-group-btn btn -hg"]')))
